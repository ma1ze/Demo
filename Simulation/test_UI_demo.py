...
loc = '/home/frederick/Desktop/testDemo/images/calib/'
...
class Interface(QWidget):
    ...
    def on_pictuerCapture_clicked(self):
        CalibImage_collecting(loc, self.Width, self.Height, self.Fps, self.Brightness, self.Contrast, self.Saturation,
